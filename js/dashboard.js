...
var actions = [];
var draftOps = data.operations.filter(function(op) { return op.status === STATUS.DRAFT && !op.is_archived && !op.parent_operation_id; });
...
if (op.status === STATUS.DRAFT && !op.parent_operation_id) draft++;
});
